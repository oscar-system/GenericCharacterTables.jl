...
function get_shift_mask(
  ring::UPolyRing, vars::Vector{Int64}, step_size::Int64, steps::Int64
)
...
function var_shift(a::GenericCycloFrac, vars::Vector{Int64}, step_size::Int64, steps::Int64)
  return evaluate(
    a, vars, get_shift_mask(base_ring(parent(a.numerator)), vars, step_size, steps)
  )
end
