...
Parameters([Parameter(a, q^2-q+1)], [ParameterException((a)*1//(q^2-q+1))], ParameterSubstitution{QQPolyRingElem}[])
]
...
Parameters([Parameter(n, q^2-q+1)], [ParameterException((n)*1//(q^2-q+1))], ParameterSubstitution{QQPolyRingElem}[])
]
