...
Some finite groups come in families. For example, the matrix groups
...
This Julia package is based on Maple code included in the CHEVIE project.

- TODO: add links to CHEVIE
- TODO: cite CHEVIE paper(s), give credits to original authors etc.
