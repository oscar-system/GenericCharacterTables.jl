...
classlength = R.([1, q^4-1, 1//2*(q^4-1), 1//2*(q^4-1), (q^2-1)*(q^4-1), 1//2*q^2*(q^2-1)*(q^4-1), 1//2*q^2*(q^2-1)*(q^4-1)])
...
information = "- Information about the Green functions of \$GL_5(2^n):2\$.
