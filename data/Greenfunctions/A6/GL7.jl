...
table = QQPolyRingElem[[
	...
	(q^2+q+1)*(q^4+q^3+q^2+q+1)*(6*q^5+5*q^4+4*q^3+3*q^2+2*q+1)*(q^2+1)*(q+1)^2,
	...
	-(q+1)*(q^2+1)*(q^2+q+1)*(5*q^5-5*q^4-4*q^3-3*q^2-2*q-1),
	...
	R(1),
	R(1)] [
	(q^2-q+1)*(q^2+q+1)*(q^2+1)*(q^4+q^3+q^2+q+1)*(q^6+q^5+q^4+q^3+q^2+q+1)*(q-1)^2*(q+1)^3,
	...
	q+1,
	R(1)] [
	(q+1)*(q^2+q+1)*(q^2-q+1)*(q^2+1)*(q^4+q^3+q^2+q+1)*(q^6+q^5+q^4+q^3+q^2+q+1)*(q-1)^4,
...
classlength = R.([
	...
	(q-1)^6*(q^6+q^5+q^4+q^3+q^2+q+1)*q^15*(q+1)^3*(q^2+q+1)^2*(q^2-q+1)*(q^4+q^3+q^2+q+1)*(q^2+1)])
