...
order = 2*q^24*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1)
table = QQPolyRingElem[[
	(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	(q^2-q+1)*(2*q^4+1)*(q^2+q+1)*(q^2+1)^2*(q+1)^4,
	(q^2+q+1)*(q^2+1)*(6*q^7+5*q^6+5*q^5+3*q^4+2*q^3+q^2+q+1)*(q+1)^2,
	...
	(q+1)*(8*q^8+13*q^7+15*q^6+15*q^5+13*q^4+10*q^3+6*q^2+3*q+1),
	...
	-(q-1)*(q+1)*(q^2+1)*(q^2+q+1)*(4*q^7+3*q^6+3*q^5+3*q^4+2*q^3+q^2+q+1),
	(q^2+q+1)*(q^2+1)*(q^2-q+1)*(q^4+1)*(q+1)^2,
	...
	-(q-1)*(q^2+q+1)*(q^2+1)*(2*q^4+q^3+q^2+q+1)*(q^2-q+1)*(q+1)^2,
	-(q+1)*(3*q^9+q^8-q^7-3*q^6-3*q^5-3*q^4-2*q^3-2*q^2-q-1),
	...
	(3*q^7+2*q^6+2*q^5+3*q^4+2*q^3+q^2+q+1)*(q^2+1)*(q-1)^2*(q+1)^2,
	...
	(q^2+1)*(q^2+q+1)*(q^2-q+1)*(q^4+1)*(q-1)^2,
	(q-1)*(q+1)*(q^2-q+1)*(q^2+1)*(4*q^7-3*q^6+3*q^5-3*q^4+2*q^3-q^2+q-1),
	-(q-1)*(3*q^9-q^8-q^7+3*q^6-3*q^5+3*q^4-2*q^3+2*q^2-q+1),
	(q^2+1)*(q^2+q+1)*(q^2-q+1)*(q^4+1)*(q-1)^2,
	(3*q^6+3*q^4+2*q^2+1)*(q-1)^2,
	-(q-1)*(2*q^4-q^3+q^2-q+1)*(q^2+1),
	...
	-(q-1)^3*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q+1)*(q^4+1)*(q^4-q^2+1),
	-(q+1)*(q^2+q+1)*(2*q^4+1)*(q^2-q+1)*(q^2+1)^2*(q-1)^3,
	(q+1)*(q^2-q+1)*(q^2+q+1)*(2*q^4-q^3+q^2-q+1)*(q^2+1)*(q-1)^2,
	(q-1)*(2*q^6+q^5-2*q^4+q^3+q^2-1)*(q^2-q+1)*(q^2+1)^2,
	-(q-1)*(3*q^9-q^8-q^7+3*q^6-3*q^5+3*q^4-2*q^3+2*q^2-q+1),
	-(q+1)*(q^2+q+1)*(q^2-q+1)*(q^2+1)^2*(q-1)^3,
	...
	(q^2+1)*(q^2+q+1)*(q^4+1)*(q-1)^2*(q+1)^2,
	-(q-1)*(q^2-q+1)*(1+q-2*q^3-q^4+q^5+2*q^6)*(q^2+1)*(q+1)^2,
	(q-1)*(q+1)*(q^7-q^2-q-1),
	(q^2+1)*(q^2+q+1)*(q^4+1)*(q-1)^2*(q+1)^2,
	-(q-1)*(q+1)*(q^2+q+1),
	...
	-(q-1)^2*(q^2+1)*(q^2-q+1)*(6*q^7-5*q^6+5*q^5-3*q^4+2*q^3-q^2+q-1),
	(q-1)^2*(9*q^8-14*q^7+15*q^6-12*q^5+9*q^4-6*q^3+4*q^2-2*q+1),
	...
	-(q-1)^2*(q+1)^2*(q^2+1)*(3*q^7-2*q^6+2*q^5-3*q^4+2*q^3-q^2+q-1),
...
classlength = R.([
	1,
	(q-1)*(q+1)*(q^2+q+1)*(q^2+1)*(q^2-q+1)*(q^4+1)*(q^4-q^2+1),
	1//2*q^3*(q-1)*(q+1)^2*(q^2+q+1)*(q^2+1)*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^3*(q-1)^2*(q+1)*(q^2+q+1)^2*(q^2+1)*(q^2-q+1)*(q^4+1)*(q^4-q^2+1),
	q^4*(q-1)^2*(q+1)^2*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	q^4*(q-1)^2*(q+1)^2*(q^2+q+1)*(q^2+1)^2*(q^2-q+1)*(q^4+1)*(q^4-q^2+1),
	q^4*(q-1)^3*(q+1)^3*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	q^8*(q-1)^3*(q+1)^3*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	q^10*(q-1)^2*(q+1)^2*(q^2+q+1)*(q^2+1)^2*(q^2-q+1)*(q^4+1)*(q^4-q^2+1),
	q^10*(q-1)^3*(q+1)^3*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^12*(q-1)^2*(q+1)^2*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^12*(q-1)^3*(q+1)^3*(q^2+q+1)^2*(q^2+1)*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^12*(q-1)^3*(q+1)^3*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^12*(q-1)^3*(q+1)^3*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//24*q^12*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//8*q^12*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//4*q^12*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//4*q^12*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//3*q^12*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^16*(q-1)^3*(q+1)^3*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^16*(q-1)^3*(q+1)^3*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^15*(q-1)^3*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^15*(q-1)^4*(q+1)^3*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	q^16*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^18*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^18*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^20*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1),
	1//2*q^20*(q-1)^4*(q+1)^4*(q^2+q+1)^2*(q^2+1)^2*(q^2-q+1)^2*(q^4+1)*(q^4-q^2+1)])
...
information = "- Information about the Green functions of \$E_6(2^n):2\$.
