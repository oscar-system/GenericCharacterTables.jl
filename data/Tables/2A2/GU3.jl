...
table = Cyclotomic{QQPolyRingElem}[[
	CycloSum(R(1), (3*u*k)*S(1//(q+1))),
	CycloSum(R(1), (3*u*k)*S(1//(q+1))),
	CycloSum(R(1), (3*u*k)*S(1//(q+1))),
	CycloSum(R(1), (2*k*u+l*u)*S(1//(q+1))),
	CycloSum(R(1), (2*k*u+l*u)*S(1//(q+1))),
	CycloSum(R(1), (u*k+u*l+u*m)*S(1//(q+1))),
	CycloSum(R(1), (u*k-u*l)*S(1//(q+1))),
	CycloSum(R(1), (u*k)*S(1//(q+1)))] [
	q*(q-1)*CycloSum(R(1), (3*u*k)*S(1//(q+1))),
	-q*CycloSum(R(1), (3*u*k)*S(1//(q+1))),
	CycloSum(R(0), S(0)),
	-(q-1)*CycloSum(R(1), (2*u*k+u*l)*S(1//(q+1))),
	CycloSum(R(1), (2*u*k+u*l)*S(1//(q+1))),
	2*CycloSum(R(1), (u*k+u*l+u*m)*S(1//(q+1))),
	CycloSum(R(0), S(0)),
	-CycloSum(R(1), (u*k)*S(1//(q+1)))] [
	q^3*CycloSum(R(1), (3*u*k)*S(1//(q+1))),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	q*CycloSum(R(1), (2*u*k+u*l)*S(1//(q+1))),
	CycloSum(R(0), S(0)),
	-CycloSum(R(1), (u*k+u*l+u*m)*S(1//(q+1))),
	CycloSum(R(1), (u*k-u*l)*S(1//(q+1))),
	-CycloSum(R(1), (u*k)*S(1//(q+1)))] [
	(q^2-q+1)*CycloSum(R(1), (2*u*k+v*k)*S(1//(q+1))),
	-(q-1)*CycloSum(R(1), (2*u*k+v*k)*S(1//(q+1))),
	CycloSum(R(1), (2*u*k+v*k)*S(1//(q+1))),
	-(q-1)*CycloSum(R(1), (u*k+v*k+u*l)*S(1//(q+1)))+CycloSum(R(1), (2*u*k+v*l)*S(1//(q+1))),
	CycloSum(R(1), (u*k+v*k+u*l)*S(1//(q+1)))+CycloSum(R(1), (2*u*k+v*l)*S(1//(q+1))),
	CycloSum(R(1), (v*k+u*l+u*m)*S(1//(q+1)))+CycloSum(R(1), (v*l+u*k+u*m)*S(1//(q+1)))+CycloSum(R(1), (v*m+u*k+u*l)*S(1//(q+1))),
	CycloSum(R(1), (v*k-u*l)*S(1//(q+1))),
	CycloSum(R(0), S(0))] [
	q*(q^2-q+1)*CycloSum(R(1), (2*u*k+v*k)*S(1//(q+1))),
	q*CycloSum(R(1), (2*u*k+v*k)*S(1//(q+1))),
	CycloSum(R(0), S(0)),
	(q-1)*CycloSum(R(1), (u*k+v*k+u*l)*S(1//(q+1)))+q*CycloSum(R(1), (2*u*k+v*l)*S(1//(q+1))),
	-CycloSum(R(1), (u*k+v*k+u*l)*S(1//(q+1))),
	-CycloSum(R(1), (v*k+u*l+u*m)*S(1//(q+1)))-CycloSum(R(1), (v*l+u*k+u*m)*S(1//(q+1)))-CycloSum(R(1), (v*m+u*k+u*l)*S(1//(q+1))),
	CycloSum(R(1), (v*k-u*l)*S(1//(q+1))),
	CycloSum(R(0), S(0))] [
	(q-1)*(q^2-q+1)*CycloSum(R(1), (u*k+v*k+w*k)*S(1//(q+1))),
	(2*q-1)*CycloSum(R(1), (u*k+v*k+w*k)*S(1//(q+1))),
	-CycloSum(R(1), (u*k+v*k+w*k)*S(1//(q+1))),
	(q-1)*(CycloSum(R(1), (u*k+v*k+w*l)*S(1//(q+1)))+CycloSum(R(1), (w*k+u*k+v*l)*S(1//(q+1)))+CycloSum(R(1), (w*k+v*k+u*l)*S(1//(q+1)))),
	-CycloSum(R(1), (u*k+v*k+w*l)*S(1//(q+1)))-CycloSum(R(1), (w*k+u*k+v*l)*S(1//(q+1)))-CycloSum(R(1), (w*k+v*k+u*l)*S(1//(q+1))),
	-CycloSum(R(1), (u*k+v*l+w*m)*S(1//(q+1)))-CycloSum(R(1), (u*k+v*m+w*l)*S(1//(q+1)))-CycloSum(R(1), (v*k+u*l+w*m)*S(1//(q+1)))-CycloSum(R(1), (v*k+w*l+u*m)*S(1//(q+1)))-CycloSum(R(1), (w*k+u*l+v*m)*S(1//(q+1)))-CycloSum(R(1), (w*k+v*l+u*m)*S(1//(q+1))),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0))] [
	(q+1)*(q^2-q+1)*CycloSum(R(1), (u*k+v*k)*S(1//(q+1))),
	CycloSum(R(1), (u*k+v*k)*S(1//(q+1))),
	CycloSum(R(1), (u*k+v*k)*S(1//(q+1))),
	(q+1)*CycloSum(R(1), (u*k+v*l)*S(1//(q+1))),
	CycloSum(R(1), (u*k+v*l)*S(1//(q+1))),
	CycloSum(R(0), S(0)),
	CycloSum(R(1), (v*k)*S(1//(q+1)))*(CycloSum(R(1), (u*l)*S(1//(q^2-1)))+CycloSum(R(1), (-q*u*l)*S(1//(q^2-1)))),
	CycloSum(R(0), S(0))] [
	(q+1)^2*(q-1)*CycloSum(R(1), (u*k)*S(1//(q+1))),
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	-CycloSum(R(1), (u*k)*S(1//(q^3+1)))-CycloSum(R(1), (-u*k*q)*S(1//(q^3+1)))-CycloSum(R(1), (q^2*u*k)*S(1//(q^3+1)))]]
