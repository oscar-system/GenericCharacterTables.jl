...
k,l,m,u,v,w, _...=gens(R, ["k", "l", "m", "u", "v", "w", "k1", "l1", "m1", "u1", "v1", "w1", "k2", "l2", "m2", "u2", "v2", "w2", "k3", "l3", "m3", "u3", "v3", "w3", "kt1", "lt1", "mt1", "ut1", "vt1", "wt1", "kt2", "lt2", "mt2", "ut2", "vt2", "wt2"])
...
table = GenericCyclo[[
	...
	-(q-1)*S(1, exponent=(u*k+v*k+u*l)*1//R((q+1)))+S(1, exponent=(2*u*k+v*l)*1//R((q+1))),
	S(1, exponent=(u*k+v*k+u*l)*1//R((q+1)))+S(1, exponent=(2*u*k+v*l)*1//R((q+1))),
	S(1, exponent=(v*k+u*l+u*m)*1//R((q+1)))+S(1, exponent=(v*l+u*k+u*m)*1//R((q+1)))+S(1, exponent=(v*m+u*k+u*l)*1//R((q+1))),
	S(1, exponent=(v*k-u*l)*1//R((q+1))),
	S(0)] [
	q*(q^2-q+1)*S(1, exponent=(2*u*k+v*k)*1//R((q+1))),
	q*S(1, exponent=(2*u*k+v*k)*1//R((q+1))),
	S(0),
	(q-1)*S(1, exponent=(u*k+v*k+u*l)*1//R((q+1)))+q*S(1, exponent=(2*u*k+v*l)*1//R((q+1))),
	...
	(q-1)*(S(1, exponent=(u*k+v*k+w*l)*1//R((q+1)))+S(1, exponent=(w*k+u*k+v*l)*1//R((q+1)))+S(1, exponent=(w*k+v*k+u*l)*1//R((q+1)))),
	-S(1, exponent=(u*k+v*k+w*l)*1//R((q+1)))-S(1, exponent=(w*k+u*k+v*l)*1//R((q+1)))-S(1, exponent=(w*k+v*k+u*l)*1//R((q+1))),
	-S(1, exponent=(u*k+v*l+w*m)*1//R((q+1)))-S(1, exponent=(u*k+v*m+w*l)*1//R((q+1)))-S(1, exponent=(v*k+u*l+w*m)*1//R((q+1)))-S(1, exponent=(v*k+w*l+u*m)*1//R((q+1)))-S(1, exponent=(w*k+u*l+v*m)*1//R((q+1)))-S(1, exponent=(w*k+v*l+u*m)*1//R((q+1))),
	S(0),
	S(0)] [
	...
	S(0),
	S(1, exponent=(v*k)*1//R((q+1)))*(S(1, exponent=(u*l)*1//R((q^2-1)))+S(1, exponent=(-q*u*l)*1//R((q^2-1)))),
	S(0)] [
	...
	S(0),
	S(0),
	-S(1, exponent=(u*k)*1//R((q^3+1)))-S(1, exponent=(-u*k*q)*1//R((q^3+1)))-S(1, exponent=(q^2*u*k)*1//R((q^3+1)))]]
...
Parameters([Parameter(k, q+1), Parameter(l, q+1)], [((k-l)*1//(q+1))]),
Parameters([Parameter(k, q+1), Parameter(l, q+1), Parameter(m, q+1)], [((k-l)*1//(q+1)), ((k-m)*1//(q+1)), ((l-m)*1//(q+1))]),
...
Parameters([Parameter(u, q+1), Parameter(v, q+1)], [((u-v)*1//(q+1))]),
Parameters([Parameter(u, q+1), Parameter(v, q+1), Parameter(w, q+1)], [((u-v)*1//(q+1)), ((u-w)*1//(q+1)), ((v-w)*1//(q+1))]),
