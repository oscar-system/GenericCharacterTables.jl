...
table = Cyclotomic{QQPolyRingElem}[[
	...
	CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	(1-q)*CycloSum(R(1), (3*n*a)*S(1//(q+1)))+CycloSum(R(1), (-6*n*a)*S(1//(q+1))),
	...
	-CycloSum(R(1), S(0)),
	-CycloSum(R(1), S(0)),
	(q-1)*(CycloSum(R(1), (3*n*a-3*m*a)*S(1//(q+1)))+CycloSum(R(1), (3*m*a-6*n*a)*S(1//(q+1)))+CycloSum(R(1), (3*n*a)*S(1//(q+1)))),
	-(CycloSum(R(1), (3*n*a-3*m*a)*S(1//(q+1)))+CycloSum(R(1), (3*m*a-6*n*a)*S(1//(q+1)))+CycloSum(R(1), (3*n*a)*S(1//(q+1)))),
	-3*(CycloSum(R(1), (m)*S(1//(3)))+CycloSum(R(1), (2*m)*S(1//(3)))),
	-(CycloSum(R(1), (m*a+(3*n-m)*b)*S(1//(q+1)))+CycloSum(R(1), (m*b+(3*n-m)*a)*S(1//(q+1)))+CycloSum(R(1), (m*(-a-b)+(3*n-m)*a)*S(1//(q+1)))+CycloSum(R(1), (m*a+(3*n-m)*(-a-b))*S(1//(q+1)))+CycloSum(R(1), (m*(-a-b)+(3*n-m)*b)*S(1//(q+1)))+CycloSum(R(1), (m*b+(3*n-m)*(-a-b))*S(1//(q+1)))),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0))] [
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	-(CycloSum(R(1), (3*n*a)*S(1//(q^2-q+1)))+CycloSum(R(1), (-3*n*a*q)*S(1//(q^2-q+1)))+CycloSum(R(1), (3*n*a*q^2)*S(1//(q^2-q+1))))]]
