...
table = Cyclotomic{QQPolyRingElem}[[
	...
	CycloSum(R(1), S(0)),
	-CycloSum(R(1), S(0))] [
	1//2*(q^2+1)*CycloSum(R(1), (1//2*(q^2-1)*i)*S(1//(2))),
	1//2*CycloSum(R(1), (1//2*(q^2-1)*i)*S(1//(2)))+1//2*q*CycloSum(R(1), (1//2*(q^2-1))*S(1//(4))),
	1//2*CycloSum(R(1), (1//2*(q^2-1)*i)*S(1//(2)))-1//2*q*CycloSum(R(1), (1//2*(q^2-1))*S(1//(4))),
	...
	CycloSum(R(1), i*S(1//(2))),
	CycloSum(R(0), S(0))] [
	1//2*(q^2-1)*CycloSum(R(1), (1//2*i*q^2+1//2*i)*S(1//(2))),
	-1//2*CycloSum(R(1), (1//2*(q^2+1)*i)*S(1//(2)))+1//2*q*CycloSum(R(1), (2*i+1//2*(q^2-1))*S(1//(4))),
	-1//2*CycloSum(R(1), (1//2*(q^2+1)*i)*S(1//(2)))-1//2*q*CycloSum(R(1), (2*i+1//2*(q^2-1))*S(1//(4))),
	CycloSum(R(0), S(0)),
	-CycloSum(R(1), i*S(1//(2)))] [
	1//2*(q^2-1)*CycloSum(R(1), (1//2*i*q^2+1//2*i)*S(1//(2))),
	...
	CycloSum(R(0), S(0)),
	-CycloSum(R(1), i*S(1//(2)))] [
	(q^2+1)*CycloSum(R(1), (i*k)*S(1//(2))),
	CycloSum(R(1), (i*k)*S(1//(2))),
	CycloSum(R(1), (i*k)*S(1//(2))),
