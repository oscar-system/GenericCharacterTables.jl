...
table = Cyclotomic{QQPolyRingElem}[[
	...
	CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	q*CycloSum(R(1), (3*n*a)*S(1//(q-1)))+CycloSum(R(1), (3*n*a)*S(1//(q-1)))+CycloSum(R(1), (-6*n*a)*S(1//(q-1))),
	CycloSum(R(1), (3*n*a)*S(1//(q-1)))+CycloSum(R(1), (-6*n*a)*S(1//(q-1))),
	(3)*CycloSum(R(1), S(0)),
	CycloSum(R(1), (3*n*a)*S(1//(q-1)))+CycloSum(R(1), (3*n*b)*S(1//(q-1)))+CycloSum(R(1), (3*n*(-a-b))*S(1//(q-1))),
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	(q+1)*CycloSum(R(1), (3*n*a)*S(1//(q-1)))+q*CycloSum(R(1), (-6*n*a)*S(1//(q-1))),
	CycloSum(R(1), (3*n*a)*S(1//(q-1))),
	(3)*CycloSum(R(1), S(0)),
	CycloSum(R(1), (3*n*a)*S(1//(q-1)))+CycloSum(R(1), (3*n*b)*S(1//(q-1)))+CycloSum(R(1), (3*n*(-a-b))*S(1//(q-1))),
	-CycloSum(R(1), (3*n*a)*S(1//(q-1))),
	...
	(q+1)*CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	(CycloSum(R(1), ((q-1)*1//3)*S(1//(3)))+CycloSum(R(1), (2*(q-1)*1//3)*S(1//(3)))),
	...
	CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	(q+1)*(CycloSum(R(1), (3*a*(n-m))*S(1//(q-1)))+CycloSum(R(1), (a*(-6*n+3*m))*S(1//(q-1)))+CycloSum(R(1), (3*n*a)*S(1//(q-1)))),
	CycloSum(R(1), (3*a*(n-m))*S(1//(q-1)))+CycloSum(R(1), (a*(3*m-6*n))*S(1//(q-1)))+CycloSum(R(1), (3*n*a)*S(1//(q-1))),
	3*(CycloSum(R(1), (m)*S(1//(3)))+CycloSum(R(1), (2*m)*S(1//(3)))),
	CycloSum(R(1), (a*m+3*b*n-b*m)*S(1//(q-1)))+CycloSum(R(1), (b*m+a*(3*n-m))*S(1//(q-1)))+CycloSum(R(1), (m*(-a-b)+3*n*a-m*a)*S(1//(q-1)))+CycloSum(R(1), (m*a+3*n*(-a-b)-m*(-a-b))*S(1//(q-1)))+CycloSum(R(1), (m*(-a-b)+3*n*b-m*b)*S(1//(q-1)))+CycloSum(R(1), (m*b+3*n*(-a-b)-m*(-a-b))*S(1//(q-1))),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0))] [
	((q-1)*(q^2+q+1))*CycloSum(R(1), S(0)),
	-CycloSum(R(1), S(0)),
	...
	-CycloSum(R(1), S(0)),
	-CycloSum(R(1), S(0)),
	(q-1)*CycloSum(R(1), (3*n*a)*S(1//(q-1))),
	-CycloSum(R(1), (3*n*a)*S(1//(q-1))),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	-(CycloSum(R(1), (3*n*a)*S(1//(q^2-1)))+CycloSum(R(1), (3*n*a*q)*S(1//(q^2-1)))),
	CycloSum(R(0), S(0))] [
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	(CycloSum(R(1), (3*n*a)*S(1//(q^2+q+1)))+CycloSum(R(1), (3*n*a*q)*S(1//(q^2+q+1)))+CycloSum(R(1), (-3*n*a-3*n*a*q)*S(1//(q^2+q+1))))]]
...
Parameters([Parameter(n, (q^2-1)*1//3)], [ParameterException((n)*1//(q+1))]),
