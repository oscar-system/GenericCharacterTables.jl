...
table = GenericCyclo[[
	...
	S(1),
	S(1),
	q*S(1, exponent=(3*n*a)*1//R((q-1)))+S(1, exponent=(3*n*a)*1//R((q-1)))+S(1, exponent=(-6*n*a)*1//R((q-1))),
	...
	S(1),
	S(1),
	(q+1)*(S(1, exponent=(3*a*(n-m))*1//R((q-1)))+S(1, exponent=(a*(-6*n+3*m))*1//R((q-1)))+S(1, exponent=(3*n*a)*1//R((q-1)))),
	S(1, exponent=(3*a*(n-m))*1//R((q-1)))+S(1, exponent=(a*(3*m-6*n))*1//R((q-1)))+S(1, exponent=(3*n*a)*1//R((q-1))),
	3*(S(1, exponent=(m)*1//R((3)))+S(1, exponent=(2*m)*1//R((3)))),
	S(1, exponent=(a*m+3*b*n-b*m)*1//R((q-1)))+S(1, exponent=(b*m+a*(3*n-m))*1//R((q-1)))+S(1, exponent=(m*(-a-b)+3*n*a-m*a)*1//R((q-1)))+S(1, exponent=(m*a+3*n*(-a-b)-m*(-a-b))*1//R((q-1)))+S(1, exponent=(m*(-a-b)+3*n*b-m*b)*1//R((q-1)))+S(1, exponent=(m*b+3*n*(-a-b)-m*(-a-b))*1//R((q-1))),
	S(0),
	S(0)] [
	((q-1)*(q^2+q+1))*S(1),
	-S(1),
	...
	S(0),
	S(0),
	(S(1, exponent=(3*n*a)*1//R((q^2+q+1)))+S(1, exponent=(3*n*a*q)*1//R((q^2+q+1)))+S(1, exponent=(-3*n*a-3*n*a*q)*1//R((q^2+q+1))))]]
