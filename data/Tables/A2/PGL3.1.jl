...
table = GenericCyclo[[
	...
	(q+1)*S(1),
	S(1),
	S(1, exponent=(n*a)*1//R((q-1)))*q+S(1, exponent=(n*a)*1//R((q-1)))+S(1, exponent=(-2*n*a)*1//R((q-1))),
	S(1, exponent=(n*a)*1//R((q-1)))+S(1, exponent=(-2*n*a)*1//R((q-1))),
	(3)*S(1),
	S(1, exponent=(-2*n*b+n*a)*1//R((q-1)))+S(1, exponent=(-2*n*a+n*b)*1//R((q-1)))+S(1, exponent=(n*a+n*b)*1//R((q-1))),
	...
	(q)*S(1),
	S(0),
	S(1, exponent=(n*a)*1//R((q-1)))*q+S(1, exponent=(n*a)*1//R((q-1)))+q*S(1, exponent=(-2*n*a)*1//R((q-1))),
	S(1, exponent=(n*a)*1//R((q-1))),
	(3)*S(1),
	S(1, exponent=(-2*n*b+n*a)*1//R((q-1)))+S(1, exponent=(-2*n*a+n*b)*1//R((q-1)))+S(1, exponent=(n*a+n*b)*1//R((q-1))),
	-S(1, exponent=(n*a)*1//R((q-1))),
	...
	(2*q+1)*S(1),
	S(1),
	(S(1, exponent=(n*a)*1//R((q-1)))+S(1, exponent=(-a*(m+n))*1//R((q-1)))+S(1, exponent=(m*a)*1//R((q-1))))*(q+1),
	S(1, exponent=(n*a)*1//R((q-1)))+S(1, exponent=(-m*a-n*a)*1//R((q-1)))+S(1, exponent=(m*a)*1//R((q-1))),
	3*S(1, exponent=(2*m+n)*1//R((3)))+3*S(1, exponent=(m+2*n)*1//R((3))),
	S(1, exponent=(n*a-m*b-n*b)*1//R((q-1)))+S(1, exponent=(n*a+m*b)*1//R((q-1)))+S(1, exponent=(m*a+n*b)*1//R((q-1)))+S(1, exponent=(-m*a-n*a+n*b)*1//R((q-1)))+S(1, exponent=(m*a-m*b-n*b)*1//R((q-1)))+S(1, exponent=(-m*a-n*a+m*b)*1//R((q-1))),
	S(0),
	S(0),
	S(0)] [
	((q-1)*(q^2+q+1))*S(1),
	...
	S(1, exponent=(n*a)*1//R((q^2+q+1)))+S(1, exponent=(n*a*q)*1//R((q^2+q+1)))+S(1, exponent=(n*a*q^2)*1//R((q^2+q+1)))]]
...
Parameters([Parameter(n, q-1)], [((n)*1//((q-1)*1//3))]),
Parameters([Parameter(n, q-1), Parameter(m, q-1)], [((n-m)*1//(q-1)), ((n+2*m)*1//(q-1)), ((m+2*n)*1//(q-1))]),
