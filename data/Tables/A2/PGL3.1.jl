...
table = Cyclotomic{QQPolyRingElem}[[
	...
	CycloSum(R(1), S(0)),
	CycloSum(R(1), (n*a)*S(1//(q-1)))*q+CycloSum(R(1), (n*a)*S(1//(q-1)))+CycloSum(R(1), (-2*n*a)*S(1//(q-1))),
	CycloSum(R(1), (n*a)*S(1//(q-1)))+CycloSum(R(1), (-2*n*a)*S(1//(q-1))),
	(3)*CycloSum(R(1), S(0)),
	CycloSum(R(1), (-2*n*b+n*a)*S(1//(q-1)))+CycloSum(R(1), (-2*n*a+n*b)*S(1//(q-1)))+CycloSum(R(1), (n*a+n*b)*S(1//(q-1))),
	...
	(q)*CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(1), (n*a)*S(1//(q-1)))*q+CycloSum(R(1), (n*a)*S(1//(q-1)))+q*CycloSum(R(1), (-2*n*a)*S(1//(q-1))),
	CycloSum(R(1), (n*a)*S(1//(q-1))),
	(3)*CycloSum(R(1), S(0)),
	CycloSum(R(1), (-2*n*b+n*a)*S(1//(q-1)))+CycloSum(R(1), (-2*n*a+n*b)*S(1//(q-1)))+CycloSum(R(1), (n*a+n*b)*S(1//(q-1))),
	-CycloSum(R(1), (n*a)*S(1//(q-1))),
	...
	CycloSum(R(1), S(0)),
	(CycloSum(R(1), (n*a)*S(1//(q-1)))+CycloSum(R(1), (-a*(m+n))*S(1//(q-1)))+CycloSum(R(1), (m*a)*S(1//(q-1))))*(q+1),
	CycloSum(R(1), (n*a)*S(1//(q-1)))+CycloSum(R(1), (-m*a-n*a)*S(1//(q-1)))+CycloSum(R(1), (m*a)*S(1//(q-1))),
	3*CycloSum(R(1), (2*m+n)*S(1//(3)))+3*CycloSum(R(1), (m+2*n)*S(1//(3))),
	CycloSum(R(1), (n*a-m*b-n*b)*S(1//(q-1)))+CycloSum(R(1), (n*a+m*b)*S(1//(q-1)))+CycloSum(R(1), (m*a+n*b)*S(1//(q-1)))+CycloSum(R(1), (-m*a-n*a+n*b)*S(1//(q-1)))+CycloSum(R(1), (m*a-m*b-n*b)*S(1//(q-1)))+CycloSum(R(1), (-m*a-n*a+m*b)*S(1//(q-1))),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0))] [
	((q-1)*(q^2+q+1))*CycloSum(R(1), S(0)),
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	3*CycloSum(R(1), (n*a)*S(1//(3))),
	CycloSum(R(1), (n*a)*S(1//(q^2+q+1)))+CycloSum(R(1), (n*a*q)*S(1//(q^2+q+1)))+CycloSum(R(1), (n*a*q^2)*S(1//(q^2+q+1)))]]
