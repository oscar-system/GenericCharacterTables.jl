...
a,b,c,s,k,u, _...=gens(R, ["a", "b", "c", "s", "k", "u", "a1", "b1", "c1", "s1", "k1", "u1", "a2", "b2", "c2", "s2", "k2", "u2", "a3", "b3", "c3", "s3", "k3", "u3", "at1", "bt1", "ct1", "st1", "kt1", "ut1", "at2", "bt2", "ct2", "st2", "kt2", "ut2"])
...
table = GenericCyclo[[
	...
	S(1),
	S(1),
	S(1, exponent=(s*a)*1//R((2*q0^2-1)))+S(1, exponent=(-s*a)*1//R((2*q0^2-1))),
	S(0),
	S(0)] [
	...
	-S(1),
	S(0),
	-(S(1, exponent=(k*b)*1//R((2*q0^2+2*q0+1)))+S(1, exponent=(-k*b)*1//R((2*q0^2+2*q0+1)))+S(1, exponent=(2*q0^2*k*b)*1//R((2*q0^2+2*q0+1)))+S(1, exponent=(-2*q0^2*k*b)*1//R((2*q0^2+2*q0+1)))),
	S(0)] [
	((2*q0^2-1)*(2*q0^2+2*q0+1))*S(1),
	(-2*q0-1)*S(1),
	-S(1),
	...
	S(0),
	S(0),
	-(S(1, exponent=(u*c)*1//R((2*q0^2-2*q0+1)))+S(1, exponent=(-u*c)*1//R((2*q0^2-2*q0+1)))+S(1, exponent=(2*q0^2*u*c)*1//R((2*q0^2-2*q0+1)))+S(1, exponent=(-2*q0^2*u*c)*1//R((2*q0^2-2*q0+1))))]]
classinfo = [
	[[1,0],["^2B_2","u_0"]],
	[[1,1],["^2B_2","u_1"]],
	[[1,2],["^2B_2","u_2"]],
