...
table = Cyclotomic{QQPolyRingElem}[[
	...
	(q*(q+1)*	(2*q+1)*1//6)*CycloSum(R(1), S(0)),
	(q*(3*q+1)*1//6)*CycloSum(R(1), S(0)),
	(q*(q+1)*1//6)*CycloSum(R(1), S(0)),
	(-q*(q-1)*1//6)*CycloSum(R(1), S(0)),
	(2*q*1//3)*CycloSum(R(1), S(0)),
	(-q*1//3)*CycloSum(R(1), S(0)),
	(-q*1//3)*CycloSum(R(1), S(0)),
	((q+1)^2*1//2)*CycloSum(R(1), S(0)),
	...
	(-q*(q-1)*1//3)*CycloSum(R(1), S(0)),
	(q*1//3)*CycloSum(R(1), S(0)),
	q*1//3+q*CycloSum(R(1), S(1//(3))),
	q*1//3+q*CycloSum(R(1), 2*S(1//(3))),
	(	0)*CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0))] [
	(q^2*(q^4+q^2+1))*CycloSum(R(1), S(0)),
	(q^2)*CycloSum(R(1), S(0)),
	(q^2)*CycloSum(R(1), S(0)),
	(q^2)*CycloSum(R(1), S(0)),
	(	0)*CycloSum(R(1), S(0)),
	...
	CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	(q+1)+(q+1)^2*CycloSum(R(1), k*S(1//(2))),
	1+(q+1)*CycloSum(R(1), k*S(1//(2))),
	q+1+(q+1)*CycloSum(R(1), k*S(1//(2))),
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	q*(q+1)+(q+1)^2*CycloSum(R(1), k*S(1//(2))),
	q+(q+1)*CycloSum(R(1), k*S(1//(2))),
