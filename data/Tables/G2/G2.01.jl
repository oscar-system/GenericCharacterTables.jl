...
table = Cyclotomic{QQPolyRingElem}[[
	...
	CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0))] [
	(q*(q+1)^2*(q^2+q+1)*1//6)*CycloSum(R(1), S(0)),
	(q*(q+1)*(2*q+1)*1//6)*CycloSum(R(1), S(0)),
	(q*(q+1)*1//2)*CycloSum(R(1), S(0)),
	(q*(q+5)*1//6)*CycloSum(R(1), S(0)),
	(-q*(q-1)*1//6)*CycloSum(R(1), S(0)),
	(q*(q-1)*1//6)*CycloSum(R(1), S(0)),
	...
	CycloSum(R(0), S(0)),
	-CycloSum(R(1), S(0))] [
	(q*(q+1)*(q^3+1)*1//2)*CycloSum(R(1), S(0)),
	(q*(q+1)*1//2)*CycloSum(R(1), S(0)),
	(q*(q+1)*1//2)*CycloSum(R(1), S(0)),
	(-q*(q-1)*1//2)*CycloSum(R(1), S(0)),
	(q*(q+1)*1//2)*CycloSum(R(1), S(0)),
	...
	-CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0))] [
	(q*(q^4+q^2+1)*1//3)*CycloSum(R(1), S(0)),
	(-q*(q^2-1)*1//3)*CycloSum(R(1), S(0)),
	(q)*CycloSum(R(1), S(0)),
	(	q*(q+5)*1//3)*CycloSum(R(1), S(0)),
	(-q*(q-1)*1//3)*CycloSum(R(1), S(0)),
	(q*(q-1)*1//3)*CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	((2*q-1)*(q^2+q+1)*1//3)*CycloSum(R(1), S(0)),
	((q-1)*1//3)*CycloSum(R(1), S(0)),
	(-(2*q+1)*1//3)*CycloSum(R(1), S(0)),
	((q-1)*1//3)*CycloSum(R(1), S(0)),
	((q-1)*1//3)*CycloSum(R(1), S(0)),
	...
	CycloSum(R(0), S(0))] [
	(q*(q^4+q^2+1)*1//3)*CycloSum(R(1), S(0)),
	(q*(2*q^2+1)*1//3)*CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	(	q*(q-1)*1//3)*CycloSum(R(1), S(0)),
	(-q*(q-1)*1//3)*CycloSum(R(1), S(0)),
	(q*(q+2)*1//3)*CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	(-(q-2)*(q^2+q+1)*1//3)*CycloSum(R(1), S(0)),
	((q+2)*1//3)*CycloSum(R(1), S(0)),
	(-2*(q-1)*1//3)*CycloSum(R(1), S(0)),
	((q+2)*1//3)*CycloSum(R(1), S(0)),
	((q+2)*1//3)*CycloSum(R(1), S(0)),
	(	1)*CycloSum(R(1), S(0)),
	...
	(-q*1//2)*CycloSum(R(1), S(0)),
	(q*1//2)*CycloSum(R(1), S(0)),
	((q-1)*(q^2-1)*1//3)*CycloSum(R(1), S(0)),
	(-(q-1)*1//3)*CycloSum(R(1), S(0)),
	((2*q+1)*1//3)*CycloSum(R(1), S(0)),
	(-(q-1)*1//3)*CycloSum(R(1), S(0)),
	(-(q-1)*1//3)*CycloSum(R(1), S(0)),
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(1), S(0))] [
	(q*(q^2-1)^2*1//3)*CycloSum(R(1), S(0)),
	(-q*(q^2-1)*1//3)*CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	(q*(q-1)*1//3)*CycloSum(R(1), S(0)),
	(-q*(q-1)*1//3)*CycloSum(R(1), S(0)),
	...
	((q-1)*1//3)*CycloSum(R(1), S(0)),
	((q-1)*1//3)*CycloSum(R(1), S(0)),
	(q-1)*1//3+q*CycloSum(R(1), S(1//(3))),
	(q-1)*1//3+q*CycloSum(R(1), 2*S(1//(3))),
	(	0)*CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	...
	CycloSum(R(1), i*S(1//(3)))+CycloSum(R(1), (-i)*S(1//(3))),
	CycloSum(R(1), (i-j)*S(1//(3)))+CycloSum(R(1), (j-i)*S(1//(3))),
	(q+1)*CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	...
	(2*(q+1))*CycloSum(R(1), S(0)),
	(2)*CycloSum(R(1), S(0)),
	(q+1)*(CycloSum(R(1), i*S(1//(3)))+CycloSum(R(1), (-i)*S(1//(3)))),
	CycloSum(R(1), i*S(1//(3)))+CycloSum(R(1), (-i)*S(1//(3))),
	2*(CycloSum(R(1), (i-j)*S(1//(3)))+CycloSum(R(1), (j-i)*S(1//(3)))),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	...
	(q+1)*CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	q*(CycloSum(R(1), i*S(1//(3)))+CycloSum(R(1), (-i)*S(1//(3)))),
	CycloSum(R(0), S(0)),
	CycloSum(R(1), (i-j)*S(1//(3)))+CycloSum(R(1), (j-i)*S(1//(3))),
	(-(q+1))*CycloSum(R(1), S(0)),
	-CycloSum(R(1), S(0)),
	...
	CycloSum(R(1), i*S(1//(3)))+CycloSum(R(1), (-i)*S(1//(3))),
	CycloSum(R(0), S(0))] [
	((q^2+q+1)*(q^3+1))*CycloSum(R(1), S(0)),
	...
	CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	(q+1)*(1+CycloSum(R(1), (3*i*k)*S(1//(q-1)))+CycloSum(R(1), (-3*i*k)*S(1//(q-1)))),
	1+CycloSum(R(1), (3*i*k)*S(1//(q-1)))+CycloSum(R(1), (-3*i*k)*S(1//(q-1))),
	(q+1)*(CycloSum(R(1), (i*k)*S(1//(q-1)))+CycloSum(R(1), (-i*k)*S(1//(q-1))))+(CycloSum(R(1), (2*i*k)*S(1//(q-1)))+CycloSum(R(1), (-2*i*k)*S(1//(q-1)))),
	(CycloSum(R(1), (i*k)*S(1//(q-1)))+CycloSum(R(1), (-i*k)*S(1//(q-1))))+(CycloSum(R(1), (2*i*k)*S(1//(q-1)))+CycloSum(R(1), (-2*i*k)*S(1//(q-1)))),
	(CycloSum(R(1), ((i-j)*k)*S(1//(q-1)))+CycloSum(R(1), ((j-i)*k)*S(1//(q-1))))+(CycloSum(R(1), ((i+2*j)*k)*S(1//(q-1)))+CycloSum(R(1), (-(i+2*j)*k)*S(1//(q-1))))+(CycloSum(R(1), ((j+2*i)*k)*S(1//(q-1)))+CycloSum(R(1), (-(j+2*i)*k)*S(1//(q-1)))),
	(q+1)*CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0))] [
	(q*(q^2+q+1)*(q^3+1))*CycloSum(R(1), S(0)),
	(q*(q^2+q+1))*CycloSum(R(1), S(0)),
	((q+1)*q)*CycloSum(R(1), S(0)),
	(	q)*CycloSum(R(1), S(0)),
	(q)*CycloSum(R(1), S(0)),
	(q)*CycloSum(R(1), S(0)),
	CycloSum(R(0), S(0)),
	...
	(q+1)*(1+CycloSum(R(1), (3*i*k)*S(1//(q-1)))+CycloSum(R(1), (-3*i*k)*S(1//(q-1)))),
	1+CycloSum(R(1), (3*i*k)*S(1//(q-1)))+CycloSum(R(1), (-3*i*k)*S(1//(q-1))),
	(q+1)*(CycloSum(R(1), (i*k)*S(1//(q-1)))+CycloSum(R(1), (-i*k)*S(1//(q-1))))+q*(CycloSum(R(1), (2*i*k)*S(1//(q-1)))+CycloSum(R(1), (-2*i*k)*S(1//(q-1)))),
	(CycloSum(R(1), (i*k)*S(1//(q-1)))+CycloSum(R(1), (-i*k)*S(1//(q-1)))),
	(CycloSum(R(1), ((i-j)*k)*S(1//(q-1)))+CycloSum(R(1), ((j-i)*k)*S(1//(q-1))))+(CycloSum(R(1), ((i+2*j)*k)*S(1//(q-1)))+CycloSum(R(1), (-(i+2*j)*k)*S(1//(q-1))))+(CycloSum(R(1), ((j+2*i)*k)*S(1//(q-1)))+CycloSum(R(1), (-(j+2*i)*k)*S(1//(q-1)))),
	(-(q+1))*CycloSum(R(1), S(0)),
	-CycloSum(R(1), S(0)),
	...
	(q+1)*(CycloSum(R(1), (i*k)*S(1//(q-1)))+CycloSum(R(1), (-i*k)*S(1//(q-1))))+(CycloSum(R(1), (2*i*k)*S(1//(q-1)))+CycloSum(R(1), (-2*i*k)*S(1//(q-1)))),
	(CycloSum(R(1), (i*k)*S(1//(q-1)))+CycloSum(R(1), (-i*k)*S(1//(q-1))))+(CycloSum(R(1), (2*i*k)*S(1//(q-1)))+CycloSum(R(1), (-2*i*k)*S(1//(q-1)))),
	(q+1)*(1+CycloSum(R(1), (i*k)*S(1//(q-1)))+CycloSum(R(1), (-i*k)*S(1//(q-1)))),
	1+CycloSum(R(1), (i*k)*S(1//(q-1)))+CycloSum(R(1), (-i*k)*S(1//(q-1))),
	(CycloSum(R(1), (i*k)*S(1//(q-1)))+CycloSum(R(1), (-i*k)*S(1//(q-1))))+(CycloSum(R(1), (j*k)*S(1//(q-1)))+CycloSum(R(1), (-j*k)*S(1//(q-1))))+(CycloSum(R(1), ((j+i)*k)*S(1//(q-1)))+CycloSum(R(1), (-(j+i)*k)*S(1//(q-1)))),
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	(q+1)*CycloSum(R(1), S(0)),
	CycloSum(R(1), S(0)),
	...
	CycloSum(R(0), S(0)),
	CycloSum(R(0), S(0)),
	CycloSum(R(1), (i*k)*S(1//(q^2+q+1)))+CycloSum(R(1), (-i*k)*S(1//(q^2+q+1)))+CycloSum(R(1), (q*i*k)*S(1//(q^2+q+1)))+CycloSum(R(1), (-q*i*k)*S(1//(q^2+q+1)))+CycloSum(R(1), (q*q*i*k)*S(1//(q^2+q+1)))+CycloSum(R(1), (-q*q*i*k)*S(1//(q^2+q+1))),
	CycloSum(R(0), S(0))] [
	((q+1)*(q^2-1)*(q^3-1))*CycloSum(R(1), S(0)),
	(-(q+1)*(q^2-1))*CycloSum(R(1), S(0)),
	(-(q^2-1))*CycloSum(R(1), S(0)),
...
charinfo = Vector{Any}[
	...
	[[3,0],["A_2",[3]],"X_{32}","\\vartheta_6"],
	[[3,1],["A_2",[2,1]],"X_{33}","\\vartheta_8"],
	[[3,2],["A_2",[1,1,1]],"X_{31}","\\vartheta_7"],
...
Parameters(Parameter{QQPolyRingElem}[]),
Parameters(Parameter{QQPolyRingElem}[]),
Parameters([Parameter(i, q-1)], [ParameterException((i)*1//((q-1)*1//3))]),
Parameters([Parameter(i, q-1)], [ParameterException((i)*1//((q-1)*1//3))]),
...
Parameters(Parameter{QQPolyRingElem}[]),
Parameters(Parameter{QQPolyRingElem}[]),
Parameters([Parameter(k, q-1)], [ParameterException((k)*1//((q-1)*1//3))]),
Parameters([Parameter(k, q-1)], [ParameterException((k)*1//((q-1)*1//3))]),
