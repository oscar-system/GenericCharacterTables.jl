...
q = gen(R, "q")
S = generic_cyclotomic_ring(R; congruence=ZZ.((1,12)))
...
function (tt::Union{GenericCyclo, GenericCycloFrac})
	...
	s6=eesubs(tt, [i,j], R.([(q-1)*1//2,(q-1)*1//2]))
	s7=eesubs(tt, [i,j], R.([(q-1)*1//2,0]))
	s8=eesubs(tt, [i,j], R.([(q-1)*1//3,(q-1)*1//3]))
	s9=eesubs(tt, [i,j], R.([2*(q-1)*1//3,2*(q-1)*1//3]))
...
function (tt::Union{GenericCyclo, GenericCycloFrac})
	...
	s6=eesubs(tt, [k,l], R.([(q-1)*1//2,(q-1)*1//2]))
	s7=eesubs(tt, [k,l], R.([(q-1)*1//2,0]))
	s8=eesubs(tt, [k,l], R.([(q-1)*1//3,2*(q-1)*1//3]))
	s9=eesubs(tt, [k,l], R.([2*(q-1)*1//3,(q-1)*1//3]))
	1//12*s2-1//12*s3-1//6*s4-1//12*s5+1//12*s6+1//6*s7+1//6*s8+1//6*s9
end,
function (tt::Union{GenericCyclo, GenericCycloFrac})
	s1=nesum(tt, k, 1, q)
